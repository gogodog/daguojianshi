  ...
  <nav class="navbar navbar-default" id="navbar">
    <div class="container">
      <div class="navbar-header">
        ...
        <h1 class="logo hvr-bounce-in"><a class="titlelog" href="${contextPath}/dgjs"><img src="${contextPath}/front/images/slogo.png">简史</a></h1>
      </div>
      <div class="collapse navbar-collapse" id="header-navbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a data-cont="简史" title="简史" href="${contextPath}/timeline">全部</a></li>
          <#list types as type>
            <li><a data-cont="简史" title="简史" href="${contextPath}/timeline?type=${type}">${type.value}</a></li>
          </#list>
        </ul>
